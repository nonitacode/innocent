    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("KING0CHANNEL")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("KING0CHANNEL")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("KING0CHANNEL")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("KING0CHANNEL")
